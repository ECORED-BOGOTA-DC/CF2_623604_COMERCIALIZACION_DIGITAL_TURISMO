...
.curso-main-container.pb-3
  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5
    ...
    .row.justify-content-center.bg99.px-md-5.px-4.mb-4
      .col-lg-6.col-10.mb-lg-0.mb-4(data-aos="fade-right")
        img(src='@/assets/curso/tema2/i1.png', alt="Imagen decorativa")
      ...
      p(data-aos="fade-right") La experiencia gastronómica, por tanto, es todo aquello que los comensales viven en nuestro restaurante, es el “viaje completo” desde que entran hasta que se marchan. Engloba tanto la dimensión física como la sensorial y ambiental, es decir, gastronomía, servicio, concepto, arquitectura, decoración. Este conjunto crea una vivencia única para el comensal, lo que hace que queden maravillados y que quieran volver a repetir la experiencia.
      .row.justify-content-center.mt-4
        .col-lg-6.order-lg-1.order-2
          p(data-aos="fade-right") Así pues, toda experiencia gastronómica debería ofrecer: 
          ul.lista-ul
        ...
        .col-lg-6.col-10.order-lg-2.order-1.mb-lg-0.mb-4(data-aos="fade-left")
          img(src='@/assets/curso/tema2/i2.png', alt="Imagen decorativa")
      p.mt-4(data-aos="fade-right") Cuando logramos brindarle ese momento memorable al turista, obtenemos su fidelidad y su satisfacción; lo que se traduce en una recompra y una publicidad gratuita, haciendo que nuestra marca sea cada vez más reconocida y que llegue a ella muchas más personas. 
    ...
    TabsC.color-primario(data-aos="zoom-in")
      .py-3.py-md-4(titulo="Experiencias gastronómicas en casa")
        .row.justify-content-center.px-2
          ...
          .col-lg-5.col-10.order-lg-2.order-1.mb-lg-0.mb-4
            figure
              img(src='@/assets/curso/tema2/i3.png', alt="Imagen decorativa")
      .py-3.py-md-4(titulo="Cajas regalo de gastronomía")
        .row.justify-content-center.px-2
          ...
          .col-lg-5.col-10.order-lg-2.order-1.mb-lg-0.mb-4
            figure
              img(src='@/assets/curso/tema2/i4.png', alt="Imagen decorativa")
      .py-3.py-md-4(titulo="Estancias gastronómicas")
        .row.justify-content-center.px-2
          ...
          .col-lg-5.col-10.order-lg-2.order-1.mb-lg-0.mb-4
            figure
              img(src='@/assets/curso/tema2/i5.png', alt="Imagen decorativa")
      .py-3.py-md-4(titulo="Turismo enológico")
        .row.justify-content-center.px-2
          ...
          .col-lg-5.col-10.order-lg-2.order-1.mb-lg-0.mb-4
            figure
              img(src='@/assets/curso/tema2/i6.png', alt="Imagen decorativa")
    ...
    p.mb-5.mt-4(data-aos="fade-right") Igualmente, alrededor del mundo entero, se pueden disfrutar un sinfín de experiencias gastronómicas, cada vez son más los lugares que buscan una recordación en sus visitantes, además, de brindarle la mejor de las experiencias, en el siguiente recurso podrá consultar algunas de estas experiencias:
      ...
      SlyderA(tipo="b")
        .row.justify-content-center
          ...
          .col-lg-7.col-10.order-lg-2.order-1.mb-lg-0.mb-4
            figure
              img(src='@/assets/curso/tema2/i8.png', alt="Imagen decorativa")
        .row.justify-content-center
          .col-lg-5.order-lg-1.order-2
        ...
        .row.justify-content-center
          ...
          .col-lg-7.col-10.order-lg-2.order-1.mb-lg-0.mb-4
            figure
              img(src='@/assets/curso/tema2/i10.png', alt="Imagen decorativa")
        .row.justify-content-center
          .col-lg-5.order-lg-1.order-2
          ...
          .col-lg-7.col-10.order-lg-2.order-1.mb-lg-0.mb-4
            figure
              img(src='@/assets/curso/tema2/i11.png', alt="Imagen decorativa")
        .row.justify-content-center
          .col-lg-5.order-lg-1.order-2
          ...
          .col-lg-7.col-10.order-lg-2.order-1.mb-lg-0.mb-4
            figure
              img(src='@/assets/curso/tema2/i12.png', alt="Imagen decorativa")
    
    separador
    #t_2_2.titulo-segundo.color-acento-contenido(data-aos="fade-right")
      h2 2.2  Determinantes de una experiencia gastronómica memorable
    
    p(data-aos="fade-right") La experiencia gastronómica va más allá de una buena cocina y un equipo experimentado a sus espaldas. Son muchos los factores que influyen para que una experiencia sea o no satisfactoria. Arhippainen y Tähti (2003), citado por González Ramos (2019), menciona que son 4 los factores los que deben interactuar entre sí para que una experiencia funcione correctamente: 
    ...
    .row.justify-content-center
      ...
      .col-lg-4.col-8.order-lg-2.order-1.mb-lg-0.mb-4(data-aos="fade-left")
        img(src='@/assets/curso/tema2/i14.png', alt="Imagen decorativa")
    
    p.mt-4(data-aos="fade-right") Así mismo Zorrilla (2002), menciona que las principales dimensiones atmosféricas incluyen:
    ...
    .row.justify-content-center.bg999.px-md-5.px-4.mt-5 
      .row.justify-content-center
        .col-lg-6.order-lg-1.order-2
          p(data-aos="fade-right") La variable motivacional es la más importante para entender al turista gastronómico, ya que el lugar que ocupa la gastronomía en la intención de un turista para viajar a un destino puede tener una importancia variable:          
          ul.lista-ul
            li(data-aos="fade-right")
              i.fas.fa-check.ss
        ...
        .col-lg-6.col-10.order-lg-2.order-1.mb-lg-0.mb-4(data-aos="fade-left")
          img(src='@/assets/curso/tema2/i18.png', alt="Imagen decorativa")
      .row.justify-content-center.mt-5
        .col-lg-6.col-10.mb-lg-0.mb-4(data-aos="fade-right")
          img(src='@/assets/curso/tema2/i19.png', alt="Imagen decorativa")
        .col-lg-6.mt-2
          p(data-aos="fade-left") Además, teniendo presente lo anterior, es importante conocer en lo posible ciertos aspectos de los turistas que llegan al destino con la intención de crear una experiencia gastronómica, lo más acertada posible. Algunas de las preguntas que se pueden responder para conocer a ese turista son:
          ul.lista-ul
    ...
    p.mt-5(data-aos="fade-right") Luego de conocer un poco sobre el perfil del turista que llega al destino, es importante definir aspectos necesarios para crear la experiencia gastronómica:
    ...
    .row.justify-content-center
      .col-lg-8(data-aos="zoom-in")
        img(src='@/assets/curso/tema2/i20.png', alt="Visitar productores e industrias alimentarias.	Comer, dormir, comprar, visitar museos y realizar actividades gastronómicas.	Realizar una ruta temática (por productos o platos) o geográfica.	Visitar el patrimonio gastronómico.	Vivir experiencias singulares.	Participar en fiestas y eventos gastronómicos.	Visitar municipios, comarcas y regiones gastronómicas")
    ...
    p.mb-5(data-aos="fade-right") Algunas de las claves que puede tener en cuenta para una experiencia memorable pueden ser consultadas en la siguiente tabla: 
    ...
    .row.justify-content-center
      .col-lg-6.order-lg-1.order-2
        p(data-aos="fade-right") El mundo de los restaurantes está en continua evolución, y es por eso que constantemente aparecen iniciativas innovadoras dignas de ser aplicadas y evaluadas como ideas de gran potencial a largo plazo. 
        p.mt-4(data-aos="fade-right") La realidad virtual se viene aplicando en ciertos restaurantes para potenciar la experiencia sensorial del comensal; <i>James Beard Foundation</i> en Nueva York, por ejemplo, incluye una experiencia de siete platos donde el comensal recibe una copa de champán y a través de su visor de realidad virtual, comienza a experimentar música, narración poética y escenarios virtuales coloridos que cambian y se animan con la llegada de cada uno de los siete platos.
        p.mt-4(data-aos="fade-right") Otros ejemplos en este tema son:
      .col-lg-6.col-10.order-lg-2.order-1.mb-lg-0.mb-4(data-aos="fade-left")
        img(src='@/assets/curso/tema2/i21.png', alt="Imagen decorativa")
    ...
    .row.justify-content-center.mb-5
      .col-lg-6.col-10.mb-lg-0.mb-4(data-aos="fade-right")
        img(src='@/assets/curso/tema2/i1.svg', alt="Imagen decorativa")
      .col-lg-6(data-aos="fade-left")
        .tarjeta.tarjeta--azul.p-4.tt
          SlyderA(tipo="b")
            .row.justify-content-center
              .col-12
            ...
            .row.justify-content-center
              .col-12
                img.asz(src='@/assets/curso/tema2/ico3.svg')
                p.mt-4 Llegó a Colombia en el año 2016 y cuenta actualmente con más de 3.000 restaurantes en su plataforma digital. 
                p.mb-0 Uber Eats ofrece a los usuarios, eficacia, eficiencia y velocidad. El plus de esta aplicación es la inmediatez, ya que los repartidores o domiciliarios realizan el 50 % de sus entregas en un tiempo de 30 minutos o menos, consiguiendo clientes felices y satisfechos con el servicio.
            .row.justify-content-center
              .col-12
                img.asz(src='@/assets/curso/tema2/ico4.svg')
                ...
                p.mb-0 Uno de los objetivos de la marca es que los usuarios encuentren a través de la app una amplia variedad de restaurantes, opciones que nunca antes habían estado disponibles en plataformas digitales y con una de las tasas de servicio más bajas del mercado.
