...
.curso-main-container.pb-3
  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5
    ...
    .row.justify-content-center.mt-5
      .col-lg-10(data-aos="fade-right")
        .cajon.color-primario.p-4.mb-4
          ...
          p.mb-0 En Colombia ya se han implementado varias rutas gastronómicas que invitan al turista a recorrer y conocer la comida regional de manera guiada y ordenada; así mismo incentivan a los extranjeros a tener una experiencia distinta y comprender otras maneras de ver el mundo.
      ...
      .col-lg-4.col-md-6.mb-3(data-aos="fade-left")
        .tarjetas-up
          ...
          .tarjetas-up_card.bg--2-claro.p-4
            ...
            p.mb-0 En este grupo se encuentra la sal de mesa (cloruro de sodio) que le da sabor a las comidas. Las sales minerales mantienen el equilibrio del metabolismo en conjunto con los azúcares, evitando la deshidratación del cuerpo y ayudando a retener agua.    

    p.mb-5(data-aos="fade-right") Todos necesitamos una alimentación lo suficientemente variada que nos garantice un aporte nutritivo adecuado, es por esto que hay otro modo de clasificar los alimentos, que se denomina la rueda de los alimentos, se trata de un recurso gráfico proporcionado a la población para seguir una alimentación segura y equilibrada, basado en la clasificación de los alimentos en diferentes grupos que tengan características nutricionales similares. El informe de 2019 del Programa Nacional de Promoción de Alimentos Saludables (PNPAS) incluyó una nueva revisión de la rueda de los alimentos para este 2020, podrá ver más en detalle al respecto en el siguiente recurso:
    
    .row.justify-content-center.mb-5
      .col-auto.bg2.px-5.py-2(data-aos="fade-right")
        h4.text-white.text-center.mb-0 Rueda de alimentos
    ...
    .row.justify-content-center.mb-5
      .col-auto.bg2.px-lg-5.px-0.py-2(data-aos="fade-right")
        h4.text-white.text-center.mb-0 Propiedades organolépticas de los alimentos
    ...
    .row.justify-content-center.mb-4
        ...
        .tarjeta.tarjeta-flip.color-primario(@mouseover="indicadorTarjetaFlip = false")
          ...
          .tarjeta-flip__contenedor
            ...
            .tarjeta-flip__contenido.p-4.p-xl-5
              img.wii(src='@/assets/curso/tema1/ico1.svg', alt="Imagen decorativa")
        ...
        .tarjeta.tarjeta-flip.color-secundario(@mouseover="indicadorTarjetaFlip = false")
          .tarjeta-flip__contenedor
            .tarjeta-flip__img.p-4(:style="{'background-image': `url(${require('@/assets/curso/tema1/fon.png')})`}")
              img.wii(src='@/assets/curso/tema1/ico3.svg')
      ...
      .col-lg-6.col-sm-10.mb-4(data-aos="fade-right")
        .tarjeta.tarjeta-flip.color-secundario(@mouseover="indicadorTarjetaFlip = false")
          .tarjeta-flip__contenedor
            .tarjeta-flip__img.p-4(:style="{'background-image': `url(${require('@/assets/curso/tema1/fon.png')})`}")
              img.wii(src='@/assets/curso/tema1/ico4.svg')
            ...
            .tarjeta-flip__contenido
              img.wii2(src='@/assets/curso/tema1/166.png')
      .col-lg-6.col-sm-10.mb-4(data-aos="fade-left")
        .tarjeta.tarjeta-flip.color-primario(@mouseover="indicadorTarjetaFlip = false")
          .indicador--hover(v-if="indicadorTarjetaFlip")
          .tarjeta-flip__contenedor
            ...
            .tarjeta-flip__contenido.p-4
              img.wii(src='@/assets/curso/tema1/ico2.svg', alt="Imagen decorativa")
    ...
    p.mb-5(data-aos="fade-right") La inocuidad de los alimentos puede definirse como el conjunto de condiciones y medidas necesarias durante la producción, almacenamiento, distribución y preparación de alimentos para asegurar que una vez ingeridos, no representen un riesgo para la salud (Ministerio de Salud Colombiano, sf.)
    
    .row.justify-content-center.mb-5
      .col-lg-6.col-10.mb-lg-0.mb-4(data-aos="fade-right")
        img(src='@/assets/curso/tema1/177.png', alt="Imagen decorativa")
      .col-lg-6(data-aos="fade-left")
        ...
        .cajon.color-acento-botones.p-4
          p.mb-0 Dichas entidades son las encargadas de visitar a los restaurantes para inspeccionar si cumplen o no, con los requisitos legales para la venta y distribución de alimentos. Se puede incluir la toma de muestras para el análisis científico y los registros de inspección. 
    
    .row.justify-content-center.mb-5
      .col-lg-10.col2.p-4(data-aos="flip-up")
        .row.justify-content-center.align-items-center
          .col-lg-1.col-sm-2.col-3
            img.tamimg(src='@/assets/curso/tema1/ico.svg', alt="Imagen decorativa")
          .col
    ...
    p.mb-5(data-aos="fade-right") En cuanto a la higiene de los alimentos más comunes en los restaurantes, debe regularse por el conjunto de normas, pautas y procedimientos que cada organización debe seguir, asegurando de esta forma la inocuidad e idoneidad de los alimentos. El objetivo es preservar la salud del consumidor respetando los principios que se explican a continuación en cada una de las etapas de la cadena alimenticia.
    ...
    SlyderF.mb-5(columnas="col-lg-6" data-aos="zoom-in")
      .tarjeta.color-primario.h-100
        ...
        .p-4
          ...
          p.mb-0 Hay que eliminar las hojas dañadas y sucias, lavarlas con agua potable y desinfectarlas con productos adecuados para tal fin.
      .tarjeta.color-primario.h-100
        figure.mb-3
      ...
      .tarjeta.color-primario.h-100
        ...
        .p-4
          h4.mb-1 Pescado
          p.mb-0 Si es fresco, los ojos deberían estar limpios, las agallas y la carne firme.
      .tarjeta.color-primario.h-100
        figure.mb-3
          img(src='@/assets/curso/tema1/222.png',  alt="Imagen decorativa")
        .p-4
          h4.mb-1 Carne
          p.mb-0 Para pollos y carnes rojas los jugos deben ser de un color claro.

    p.mb-5(data-aos="fade-right") En cuanto a los factores de riesgo habituales que pueden afectar los alimentos, se encuentran principalmente:
    ...
    .row.justify-content-center.mb-4
      ...
      .col-lg-6.col-10.order-lg-2.order-1.mb-lg-0.mb-4(data-aos="fade-left")
        img(src='@/assets/curso/tema1/233.png',  alt="imagen de una persona, que indica los aspectos a tener en cuenta para trabajar en el área de preparación de alimentos, estos son: 1. Recoger el cabello. 2. Evitar la barba. 3. No usar joyas. 4. Uñas limpias. 5. Lavarse las manos. 6. Evitar tocarse. 7. Suspender labores en caso de enfermedad. 8. Baño diario en los pies. 9. Calzado anti-deslizante. 10. Ropa y calzados limpios. 11. Control médico. 12. Lavado de manos. 13. No toser ni estornudar. 14. No fumar, ni comer. 15. No usar maquillaje")
    ...
    .row.justify-content-center.mb-5
      .col-lg-10(data-aos="fade-right")
        .cajon.color-primario.p-4
          p.mb-0 Elaborar el menú parece fácil, pero en realidad es uno de los aspectos más difíciles de hacer dentro de una cocina, ya que debe buscar el equilibrio entre varios factores como lo son los productos disponibles, la especialidad del restaurante, el tipo de comensal al cual va enfocado, los precios de los alimentos, margen de utilidad, entre otros.  El objetivo principal siempre será crear platos rentables para el restaurante y que estos sean los más pedidos por los comensales, por ello es importante analizar la composición del menú teniendo en cuenta las variables mencionadas.
    
    p(data-aos="fade-right") Una vez terminado el diseño del menú y de la carta, será importante darlas a conocer de manera digital, haciendo uso de redes sociales o de la página <i>web</i> del restaurante; esto con la intención de impulsar las ventas y dar a conocer la marca a más clientes.
    p.mb-5(data-aos="fade-right") En cuanto a los principales tipos de menús, son incontables, pues dependen del tipo de oferta de cada establecimiento, además de la manera en que se encuentren agrupados los platos ofertados, sin embargo, a continuación, podrá tener una clasificación general de estos menús:
    
    .tarjeta.tarjeta--azul.p-4.bg3(data-aos="fade-right")
      ...
      SlyderA(tipo="b")
        .row.justify-content-center.px-2
          ...
          .col-lg-6.col-10.order-lg-2.order-1.mb-lg-0.mb-4
              img(src='@/assets/curso/tema1/80.png', alt="Imagen decorativa")
        .row.justify-content-center.px-2
          .col-lg-6.order-lg-1.order-2
          ...
          .col-lg-6.col-10.order-lg-2.order-1.mb-lg-0.mb-4
              img(src='@/assets/curso/tema1/26.png', alt="Imagen decorativa")
        .row.justify-content-center.px-2
          .col-lg-6.order-lg-1.order-2
          ...
          .col-lg-6.col-10.order-lg-2.order-1.mb-lg-0.mb-4
              img(src='@/assets/curso/tema1/27.png', alt="Imagen decorativa")
        .row.justify-content-center.px-2
          .col-lg-6.order-lg-1.order-2
        ...
        .row.justify-content-center.px-2
          ...
          .col-lg-6.col-10.order-lg-2.order-1.mb-lg-0.mb-4
              img(src='@/assets/curso/tema1/29.png', alt="Imagen decorativa")
        .row.justify-content-center.px-2
          .col-lg-6.order-lg-1.order-2
          ...
          .col-lg-6.col-10.order-lg-2.order-1.mb-lg-0.mb-4
              img(src='@/assets/curso/tema1/300.png', alt="Imagen decorativa")
        .row.justify-content-center.px-2
          .col-lg-6.order-lg-1.order-2
    ...
    .row.justify-content-center.mb-5
      .col-lg-6.mb-lg-0.mb-4(data-aos="fade-right")
        img(src='@/assets/curso/tema1/33.png', alt="Imagen decorativa")
      .col-lg-6(data-aos="fade-left")
        .cajon.color-primario.p-4.mb-4
    ...
    TabsB.color-primario.mb-5(data-aos="zoom-in")
      .py-4.py-md-5(titulo="Bebidas alcohólicas" :icono="require('@/assets/curso/tema1/ico5.svg')")
        .row
          ...
          .col-lg-5.col-10.order-lg-2.order-1.mb-lg-0.mb-4
            img(src='@/assets/curso/tema1/i1.png', alt="Imagen decorativa")
      .py-4.py-md-5(titulo="Bebidas no alcohólicas" :icono="require('@/assets/curso/tema1/ico6.svg')")
        .row
          ...
          .col-lg-5.col-10.order-lg-2.order-1.mb-lg-0.mb-4
            img(src='@/assets/curso/tema1/i2.png', alt="Imagen decorativa")
    
    p(data-aos="fade-right") Al igual que con el menú de alimentos, las bebidas también exigen unas consideraciones en el diseño de su carta.
    p(data-aos="fade-right") Si hablamos del mercado de bebidas debemos saber que tiene un gran margen de beneficio, llegando a triplicar su coste con respecto al precio de venta al público (PVP). Además, las bebidas son un producto que se puede vender por unidades y de rápido servicio.
  
    .row.mt-5
      .col-auto.bg5.px-lg-5.px-4.py-2
        h4.text-white.text-center.mb-0 Consideraciones en la carta de bebidas    
    ...
    .row.justify.content-center.mt-4
      ...
      .col-lg-6(data-aos="fade-left")  
        img(src='@/assets/curso/tema1/i3.png', alt="Imagen decorativa")
    
    p.mt-5(data-aos="fade-right") La tendencia actual es tener cartas reducidas porque facilitan al cliente su elección, acortan el tiempo de toma de la comanda y reducen el número de artículos de almacén.
      ...
      .col-lg-10.col2.p-4(data-aos="flip-up")
        .row.justify-content-center.align-items-center
          ...
          .col
            .row.justify-content-between.align-items-center
              .col.mb-3.mb-sm-0
                h5 Puede consultar una carta de bebidas a manera de ejemplo, en el siguiente enlace:
              .col-sm-auto
                a.boton.me-3.indicador__container(
    ...
    p.mb-5(data-aos="fade-right") En relación a la colección de bebidas nacionales, son varias y variadas las que degustan el paladar de propios y foráneos, podrá consultar las más conocidas en el siguiente recurso educativo: 
    ...
    .tarjeta.tarjeta--gris.p-4(data-aos="zoom-in")
      PasosB.color-primario
        .row.justify-content-center(titulo="Agua de panela")
          ...
          .col-lg-6.col-10.order-lg-2.order-1.mb-lg-0.mb-4
            figure
              img(src='@/assets/curso/tema1/50.png', alt="Imagen decorativa")
        .row.justify-content-center(titulo="Champús colombiano")
          ...
          .col-lg-6.col-10.order-lg-2.order-1.mb-lg-0.mb-4
            figure
              img(src='@/assets/curso/tema1/51.png', alt="Imagen decorativa")
        ...
        .row.justify-content-center(titulo="Viche")
          ...
          .col-lg-6.col-10.order-lg-2.order-1.mb-lg-0.mb-4
            figure
              img(src='@/assets/curso/tema1/i4.png', alt="Imagen decorativa")
        .row.justify-content-center(titulo="Aguardiente")
          ...
          .col-lg-6.col-10.order-lg-2.order-1.mb-lg-0.mb-4
            figure
              img(src='@/assets/curso/tema1/i5.png', alt="Imagen decorativa")
        .row.justify-content-center(titulo="Chirrinchi")
          ...
          .col-lg-6.col-10.order-lg-2.order-1.mb-lg-0.mb-4
            figure
              img(src='@/assets/curso/tema1/i6.png', alt="Imagen decorativa")
        .row.justify-content-center(titulo="Borojó")
          ...
          .col-lg-6.col-10.order-lg-2.order-1.mb-lg-0.mb-4
            figure
              img(src='@/assets/curso/tema1/i7.png', alt="Imagen decorativa")
        .row.justify-content-center(titulo="Sabajón")
          ...
          .col-lg-6.col-10.order-lg-2.order-1.mb-lg-0.mb-4
            figure
              img(src='@/assets/curso/tema1/56.png', alt="Imagen decorativa")
      ...
      .col-lg-10(data-aos="fade-right")
        .row
          .col-12
            .cajon.color-primario.p-4.mb-4
              h5 Emplatar
              p.mb-0 Es colocar los elementos de una preparación en el plato, de modo que al comensal le resulte agradable a la vista y le resulte fácil y placentero de comer.
    
    p.mb-5(data-aos="fade-right") Al momento de emplatar, es necesario tener en cuenta cuales son los componentes del plato a servir, algunas de las consideraciones más comunes para llevar a cabo esta tarea, se encuentran descritas a continuación:        
    
    SlyderF.mb-5(columnas="col-lg-6 col-xl-4" data-aos="zoom-in")
      .tarjeta.color-acento-contenido.color12
        .row.justify-content-center
          .col-12
            img(src='@/assets/curso/tema1/82.png',  alt="Imagen decorativa")
        .row.p-3
          h4.mb-1 La proteína
      ...
      .tarjeta.color-acento-contenido.color12
        .row.justify-content-center
          .col-12
            img(src='@/assets/curso/tema1/60.png',  alt="Imagen decorativa")
        .row.p-3
      ...
      .tarjeta.color-acento-contenido.color12
        .row.justify-content-center
          .col-12
            img(src='@/assets/curso/tema1/61.png',  alt="Imagen decorativa")
        .row.p-3
          h4.mb-1 Las salsas
      ...
      .tarjeta.color-acento-contenido.color12
        .row.justify-content-center
          .col-12
            img(src='@/assets/curso/tema1/62.png',  alt="Imagen decorativa")
        .row.p-3
    ...
    .row.justify-content-center
      .col-lg-10
        ...
        .row.justify-content-center
          ...
          .col-lg-2
            img.azx(src='@/assets/curso/tema1/12.svg')

    p.mt-4(data-aos="fade-right") A continuación, encontrará descrita estas reglas para una mejor apreciación de cómo llevar a cabo el servicio:
    
    .tarjeta.tarjeta--azul.p-4.mb-5.mt-5.bg7(data-aos="zoom-in")
      SlyderA.tema1-6(tipo="b")
        ...
        .row.justify-content-center.px-2
          ...
          .col-lg-5.col-10.order-lg-2.order-1.mb-lg-0.mb-4   
            img(src='@/assets/curso/tema1/t2.png', alt="Imagen decorativa")
        .row.justify-content-center.px-2
          .col-lg-5.order-lg-1.order-2
          ...
          .col-lg-5.col-10.order-lg-2.order-1.mb-lg-0.mb-4   
            img(src='@/assets/curso/tema1/t3.png', alt="Imagen decorativa")
        .row.justify-content-center.px-2
          .col-lg-5.order-lg-1.order-2
          ...
          .col-lg-5.col-10.order-lg-2.order-1.mb-lg-0.mb-4   
            img(src='@/assets/curso/tema1/t4.png', alt="Imagen decorativa")
        .row.justify-content-center.px-2
          .col-lg-5.order-lg-1.order-2
          ...
          .col-lg-5.col-10.order-lg-2.order-1.mb-lg-0.mb-4   
            img(src='@/assets/curso/tema1/t5.png', alt="Imagen decorativa")
        .row.justify-content-center.px-2
          .col-lg-5.order-lg-1.order-2
          ...
          .col-lg-5.col-10.order-lg-2.order-1.mb-lg-0.mb-4   
            img(src='@/assets/curso/tema1/t6.png', alt="Imagen decorativa")
        .row.justify-content-center.px-2
          .col-lg-5.order-lg-1.order-2
          ...
          .col-lg-5.col-10.order-lg-2.order-1.mb-lg-0.mb-4   
            img(src='@/assets/curso/tema1/t7.png', alt="Imagen decorativa")
        .row.justify-content-center.px-2
          .col-lg-5.order-lg-1.order-2
          ...
          .col-lg-5.col-10.order-lg-2.order-1.mb-lg-0.mb-4   
            img(src='@/assets/curso/tema1/t8.png', alt="Imagen decorativa")
        .row.justify-content-center.px-2
          .col-lg-5.order-lg-1.order-2
          ...
          .col-lg-5.col-10.order-lg-2.order-1.mb-lg-0.mb-4   
            img(src='@/assets/curso/tema1/t9.png', alt="Imagen decorativa")
        .row.justify-content-center.px-2
          .col-lg-5.order-lg-1.order-2
            h4 Emplatado cuadrado u horizontal
            p.mt-5 Se utilizan los elementos en forma de cubos o formas similares.
          .col-lg-5.col-10.order-lg-2.order-1.mb-lg-0.mb-4   
            img(src='@/assets/curso/tema1/t10.png', alt="Imagen decorativa")
        .row.justify-content-center.px-2
          .col-lg-5.order-lg-1.order-2
          ...
          .col-lg-5.col-10.order-lg-2.order-1.mb-lg-0.mb-4   
            img(src='@/assets/curso/tema1/t11.png', alt="Imagen decorativa")
    
    .row.justify-content-center.mt-4
      .col-lg-10.col2.p-4(data-aos="flip-up")
        .row.justify-content-center.align-items-center
          .col-lg-1.col-sm-2.col-3
            img.tamimg(src='@/assets/curso/tema1/13.svg', alt="Imagen decorativa")
          .col
            .row.justify-content-between.align-items-center
              .col.mb-3.mb-sm-0
                h5.mb-0 Puede consultar más acerca de este interesante tema sobre el emplatado, en el siguiente enlace:
              .col-sm-auto
                a.boton.me-3.indicador__container(
    ...
    p.mb-5(data-aos="fade-right") Son varios los factores que influyen en una experiencia positiva con respecto al menaje, a continuación, encontrará descrito cada uno de estos y su injerencia en la presentación del plato, y el gusto e interés de los comensales
    ...
    .row.justify.content-center.mb-4
      ...
      .col-lg-4.mt-4(data-aos="fade-left")
        img(src='@/assets/curso/tema1/66.png', alt="Imagen decorativa")
    ...
    .row.justify-content-center
      ...
      .col-lg-4(data-aos="flip-up")
        img(src='@/assets/curso/tema1/68.png', alt="Imagen decorativa")
    ...
    p.mt-4(data-aos="fade-right") Entre las ventajas de las plataformas de reservas <i>online</i> se encuentran las siguientes:
    ...
    p(data-aos="fade-right") Calcular el costo de los alimentos es muy importante para un restaurante, principalmente porque permite tener claridad sobre el margen de utilidad y rentabilidad del negocio, además de establecer el precio de los alimentos y bebidas. A continuación, encontrará información ampliada al respecto, además de invitar a consultar el artículo de Morillo Moreno, M (2009). Costos del servicio de alimentos y bebidas en establecimientos de alojamientos turísticos Visión Gerencial, núm. 2, pp. 304-327 Universidad de los Andes Mérida, Venezuela. <a href="https://www.redalyc.org/pdf/4655/465545881013.pdf" target="_blank" style="color: #2196F3 !important; font-weight: 900">Costos del servicio de alimentos y bebidas en establecimientos de alojamientos turísticos</a>  en su sección 2, encontrará explicación a este tema tan interesante. 
    
    SlyderF.mb-5.mt-5(columnas="col-lg-6 col-xl-4" data-aos="zoom-in")
      ...
      .tarjeta.color-acento-contenido.p-4.mt-5
        .row.justify-content-center.mb-3.mt-4
          .col-7.marg
            img(src='@/assets/curso/tema1/icono2.svg',  alt="Imagen decorativa")
      ...
      .tarjeta.color-acento-contenido.p-4.mt-5
        .row.justify-content-center.mb-3.mt-4
          .col-7.marg
            img(src='@/assets/curso/tema1/icono3.svg',  alt="Imagen decorativa")
      ...
      .tarjeta.color-acento-contenido.p-4.mt-5
        .row.justify-content-center.mb-3.mt-4
          .col-7.marg
            img(src='@/assets/curso/tema1/icono4.svg',  alt="Imagen decorativa")
      ...
      .tarjeta.color-acento-contenido.p-4.mt-5
        .row.justify-content-center.mb-3.mt-4
          .col-7.marg
            img(src='@/assets/curso/tema1/icono5.svg',  alt="Imagen decorativa")
